  ...
  if ($cek > 0) {
    ...
    if ($data['user'] == $username && $data['password'] == $password) {
      ...
      if($data['role'] == 3){
        ...
        echo "<script>alert('Login Berhasil Sebagai $data[nama]');document.location.href='../pages/mahasiswa/profile-mahasiswa.php';</script>";
      }else{
...
<body style="background-image: url('../assets/img/unpad-bg.jpg'); background-size: 100%;">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              <div class="card-header"><h4>Login Mahasiswa</h4></div>
              <div class="card-body">
                <img src="../assets/img/logo-unpad.png" alt="logo" width="150" class="rounded mx-auto d-block">
