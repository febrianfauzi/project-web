...
$nidn = $_POST['nidn'];
$dosen = mysqli_query($conn,"select * from dosen where nidn = '$nidn'");
		...
		<div class="form-row d-flex align-items-center justify-content-center" >
			<div class="row col-md-12">
				<div class="col-lg-2 mb-1">
					<input type="text" class="form-control" name="nidn" placeholder="NIP" tabindex="1" value="<?php echo $row['nidn'] ?>" readonly required>
				</div>
				<div class="col-lg-2 mb-1">
