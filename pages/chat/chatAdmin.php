      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="../admin/index.php">Sistem Skripsi</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="../admin/index.php">SS</a>
          </div>
          <ul class="sidebar-menu">
      <li><a class="nav-link" href="../admin/index.php"><i class="fas fa-university"></i> <span>Beranda</span></a></li>
      <li><a class="nav-link" href="../admin/mahasiswa.php"><i class="fas fa-graduation-cap"></i> <span>Mahasiswa</span></a></li>
      <li><a class="nav-link" href="../admin/dosen.php"><i class="fas fa-chalkboard-teacher"></i> <span>Dosen</span></a></li>
      <li class="active"><a class="nav-link" href="chatAdmin.php"><i class="fas fa-comment-dots"></i> <span>Pesan</span></a></li>
    </ul>
        </aside>
      </div>
                ...
                <div class="received_withd_msg">
                  ...
                  <div class="type_msg">
                    <div class="input_msg_write">
                      ...
                      <button class="msg_send_btn" type="button" onclick="kirimPesan()"><i class="fas fa-paper-plane" aria-hidden="true"></i></button>
